{
  description = "A workflow-complete polyglot (rust+python) project on the agentic core";
    ...
    flake-parts.lib.mkFlake {inherit inputs;} ({config, ...}: {
      ...
      perSystem = _: {
        devenv.shells.default = {
          imports = [config.flake.modules.devenv.agentic config.flake.modules.devenv.polyglot];
